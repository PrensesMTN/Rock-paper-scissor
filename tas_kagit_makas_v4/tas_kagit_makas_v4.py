...
ROCK_IMG = pygame.image.load(os.path.join(CURRENT_PATH, 'C://Users//Prenses//Desktop//python//ÖDEVLER//tas.jpeg'))
PAPER_IMG = pygame.image.load(os.path.join(CURRENT_PATH, 'C://Users//Prenses//Desktop//python//ÖDEVLER//kagıt.jpeg'))
SCISSORS_IMG = pygame.image.load(os.path.join(CURRENT_PATH, 'C://Users//Prenses//Desktop//python//ÖDEVLER//makas.jpeg'))
...
if __name__ == "__main__":
    main() # hocam ben böyle bir kod yazdım fakat resimler çok büyük ama onun dışında çalışıyor